...
<div class="space-y-6" x-data="{ showImportModal: false }">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center gap-2.5">
            ...
            <!-- Button Tarik API -->
            <a href="{{ route('admin.api-integration.index') }}" class="inline-flex items-center px-4 py-2 rounded-xl bg-indigo-50 hover:bg-indigo-100 text-indigo-700 text-xs font-bold border border-indigo-200 transition-colors">
